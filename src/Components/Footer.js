...
import { GithubLogo, InstagramLogo, MailIkon, SnapchatLogo } from '../assets/icons/index.js';

function Footer() {
    return (
        <div className="Footer">
            <div className="sosiale-medier">
                <a href="https://www.snapchat.com/add/edvardhoiby"
                target="blank">
                    <SnapchatLogo className="Snapchat-icon icon" />
                </a>
                <a href="https://github.com/3ddyBoi"
                target="blank">
                    <GithubLogo className="Github-icon icon" />
                </a>
                <a href="https://www.instagram.com/3ddyboii/"
                target="blank">
